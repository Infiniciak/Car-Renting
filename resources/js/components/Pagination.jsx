        ...
        <div className="flex items-center justify-between mt-8 px-4">
            ...
            <div className="flex gap-2">
                <button
                    ...
                    className="px-4 py-2 rounded-xl font-bold text-sm bg-white border border-gray-200 hover:bg-gray-50 disabled:opacity-30 disabled:cursor-not-allowed transition"
                >
                    ← Poprzednia
                </button>
                ...
                {endPage < lastPage && (
                    <>
                        {endPage < lastPage - 1 && <span className="px-2 py-2 text-gray-400">...</span>}
                        <button
