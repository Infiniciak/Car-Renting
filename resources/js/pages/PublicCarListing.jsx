    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white font-sans transition-colors duration-300">
                                    ...
                                    <div key={car.id} className="group bg-white dark:bg-gray-800 rounded-[2rem] border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col">
                                        <div className="h-48 bg-gray-100 dark:bg-gray-700 relative overflow-hidden">
                                            ...
                                            <div className="absolute bottom-4 right-4 flex gap-1">
                                                {car.has_gps && <span className="bg-emerald-500 text-white text-[8px] px-2 py-0.5 rounded font-bold uppercase">GPS</span>}
                                                {car.has_air_conditioning && <span className="bg-blue-500 text-white text-[8px] px-2 py-0.5 rounded font-bold uppercase">A/C</span>}
                                            </div>
            ...
            {compareList.length > 0 && (
                <div className="fixed bottom-8 left-1/2 -translate-x-1/2 bg-gray-900/95 backdrop-blur-md text-white px-8 py-5 rounded-[2rem] shadow-2xl flex items-center gap-8 z-[100] border border-white/10">
                    <div className="flex flex-col">
                        <span className="text-[10px] font-black text-indigo-400 uppercase tracking-widest">Porównywarka</span>
                        <span className="text-xs font-bold">{compareList.length} z 3 wybranych</span>
                    </div>
                    ...
                    <div className="flex gap-4">
                        ...
                        <button onClick={() => navigate('/compare', { state: { cars: compareList } })} className="bg-indigo-600 px-8 py-3 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-indigo-500 transition active:scale-95">
                            Porównaj Teraz &rarr;
                        </button>
                    </div>
                </div>
